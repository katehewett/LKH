...
if args.gtagex=='cas7_t0_x4b':
    ...
    n_grid = args.gtagex + ' f2017.12.13'
else: 
...
fn_o = Ldir['parent'] / 'WIP_output' / 'WOAC' / args.gtagex / args.job_type
...
ds['DA'] = (('xi_rho'),DA,{'units': 'm^2'})
ds['DA'].attrs['standard_name'] = 'cell area'
ds['DA'].attrs['long_name'] = 'cell horizontal area'
ds['DA'].attrs['grid file'] =  n_grid 
