...
if args.surf==True:
    fn_i = Ldir['parent'] / 'LKH_output' / 'WOAC' / args.gtagex / 'surface_maps'    
    #Lfun.make_dir(fn_o, clean=False)
elif args.bot==True:
    fn_i = Ldir['parent'] / 'LKH_output' / 'WOAC' / args.gtagex / 'bottom_maps' 
    fn_o = Ldir['parent'] / 'LKH_output' / 'WOAC' / args.gtagex / 'bottom_maps' / 'percent_time' 
    Lfun.make_dir(fn_o, clean=False)
