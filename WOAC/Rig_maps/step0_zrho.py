...
# output dir 
fn_o =  Ldir['parent'] / 'LKH_output' / 'WOAC' / 'cas7_t0_x4b' / 'Rig_maps'
Lfun.make_dir(fn_o, clean=False)
fn_final = fn_o / 'OA_indicators_z_rho.nc'
...
ds1['z_w'] = (('eta_rho', 'xi_rho'),iz_rho,{'units': 'm'})
ds1['z_w'].attrs['standard_name'] = 'z_rho'
ds1['z_w'].attrs['long_name'] = 'vertical position on s_rho grid, positive up'
ds1['z_w'].attrs['grid'] =  'cas7_t0_x4b'
