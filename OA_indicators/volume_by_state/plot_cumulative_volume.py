...
for ydx in range(0,numyrs): 
    ...
    cv_wa = wvol['Vcumsum']/1e9
    cv_or = ovol['Vcumsum']/1e9  
    ot = wvol['ocean_time']
    ...
    ax1.plot(yd,cv_wa/1000,c = Rcolors[ydx],linewidth=3, alpha=0.8,label = str(yr_list[ydx]))
    ax1.set_ylabel('cumulative volume 1000*$\mathregular{km^{3}}$')
    
    ax2.plot(yd,cv_or/1000,c = Rcolors[ydx],linewidth=3, alpha=0.8,label = str(yr_list[ydx]))
    ax2.set_ylabel('cumulative volume 1000*$\mathregular{km^{3}}$')
...
if args.variable == 'arag1':    
    fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/volumes_by_threshold/bystate/arag1/plots/Oag_state_above1_NEW.png')
elif args.variable == 'arag05':    
    fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/volumes_by_threshold/bystate/arag05/plots/Oag_state_above05_NEW.png')
