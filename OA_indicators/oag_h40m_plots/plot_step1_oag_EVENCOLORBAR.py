...
run plot_step1_oag_EVENCOLORBAR -bot True < plots bottom 
run plot_step1_oag_EVENCOLORBAR -surf True < plots surface 
...
if args.surf==True: 
    fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/oag_h40m_plots/plot_output/MEAN_surf_map_Oag_NEW_EVENCOLORBAR.png')
elif args.bot==True: 
    fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/oag_h40m_plots/plot_output/MEAN_bot_map_Oag_NEW_EVENCOLORBAR.png')
