...
but vol below 1 for each region 
...
for ydx in range(0,numyrs): 
    ...
    for mm in lat_list:
        ...
        Vpercent[mm] = (Vregion[mm]/Vtotal[mm])*100 
...
fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/volumes_by_threshold/byregion/arag1/plots/Oag_regional_below1_NEW.png')
