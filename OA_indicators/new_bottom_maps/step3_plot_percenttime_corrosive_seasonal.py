...
figname = 'NEW_seasonal_percent_time_ARAG'+str(threshold)+'.png'
...
cpsu2 = axsu.pcolormesh(P2['lon_rho'], P2['lat_rho'], P2['summer'],vmin=0,vmax=100,cmap=cm.roma_r)
