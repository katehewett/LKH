...
# PLOT 
levels = [0,10,40,70,100,130,160,190,220,250]
...
cbar = fig1.colorbar(pcm, extend = 'max')
...
sys.exit()
fig1.savefig('/Users/katehewett/Documents/LKH_output/OA_indicators/cas7_t0_x4b/volumes_by_threshold/byregion/arag1/plots/stoplight_fullscale.png')