"""
ARAG < = 1  percent time bottom water calculated using test_calc_bottom_Oag_percentage.py
...
ds = xr.open_dataset('/Users/katehewett/Documents/LKH_output/tests/percent_corrosive/2017_2022_bottom_water_corrosive_percentages.nc')

threshold = 'corrosive'    # choices mild corrosive severe 
...
axw.contour(xrho,yrho,winter2, [50,75,90],
colors=['violet','lightpink','red'], linewidths=1, linestyles='solid')  

axs.contour(xrho,yrho,spring2, [50,75,90],
colors=['violet','lightpink','red'], linewidths=1, linestyles='solid')   

axsu.contour(xrho,yrho,summer2, [50,75,90],
colors=['violet','lightpink','red'], linewidths=1, linestyles='solid')   

axf.contour(xrho,yrho,fall2, [50,75,90],
colors=['violet','lightpink','red'], linewidths=1, linestyles='solid')   

#fig.savefig('/Users/katehewett/Documents/LKH_output/tests/percent_corrosive/seasonal_percent_corrosive_severecontour.png', dpi=100)
