...
This is a README that helps setup interactions with the ooi data explorations. It also details adding SSH keys to your github, and basic how-tos on forks, git branch and remotes explained. 
...
***KMH TODOs*** *[last update 8 December 2024]:*  
...
***---Have not tested [start]---***    

OOI README makes the following suggestion:  
```
while working == true  
    git add <files>  
    git commit -am "Commit Message" 
...
## STEP 4: After the pull request - delete the old branch and update 
***---Have not tested [start]---***   
OOI README makes the following suggestion:  
...
your working branches both on your local machine and from your GitHub repository.*
```
git checkout master
git pull
git push origin master
...
Different teams have different workflows. Will update as I go forward. 
...
## Kate's reminder Notes and helpful links (remove when finalize): 
