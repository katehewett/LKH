...
LOotb = pd.to_datetime(LO2_ds.ocean_time)
#LOz1 = np.nanmean(LO_ds.z_rho.values[:,(27,28,29)])
if vel == 'u':
    LO1 = np.nanmean(LO_ds.u.values[:,(27,28,29)],axis=1)
    ...
    LO1b = np.nanmean(LO2_ds.u.values[:,(27,28,29)],axis=1)
    LO7b = LO2_ds.u.values[:,-4]
    LO20b = LO2_ds.u.values[:,-7]
    LO80b = LO2_ds.u.values[:,17]
    LO500b = LO2_ds.u.values[:,2]
...
if vel == 'v':
    ...
    LO1b = np.nanmean(LO_ds.u.values[:,(27,28,29)],axis=1)
    LO7b = LO2_ds.u.values[:,-4]
    LO20b = LO2_ds.u.values[:,-7]
    LO80b = LO2_ds.u.values[:,17]
    LO500b = LO2_ds.u.values[:,2]
...
ax1.plot(LOot,LO1,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid1)
ax1.plot(LOotb,LO1b,color = 'Grey', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid2)
...
ax2.plot(LOot,LO7,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid1)
ax2.plot(LOotb,LO7b,color = 'Grey', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid2)
#ax1.plot(LOot,LO1,color = 'pink', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid)
...
ax3.plot(LOot,LO20,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid1)
ax3.plot(LOotb,LO20b,color = 'Grey', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid2)
#ax1.plot(LOot,LO1,color = 'pink', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid)
...
ax4.plot(LOot,LO80,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid1)
ax4.plot(LOotb,LO80b,color = 'Grey', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid2)
#ax1.plot(LOot,LO1,color = 'pink', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid)
...
ax5.plot(LOot,LO500,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid1)
ax5.plot(LOotb,LO500b,color = 'Grey', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid2)
#ax1.plot(LOot,LO1,color = 'pink', marker='none', alpha=0.8, linestyle='-', linewidth = 2, label = grid)
...
figname = moor+'_'+vel+'_'+str(thisyr)+'_timeseries_both.png'
