...
u_daily_stats = u_daily_stats.reset_index()
v_daily_stats = v_daily_stats.reset_index()

u_daily_stats.loc[0,'date']=dt1
#u_daily_stats.loc[len(u_daily_stats)+1,'date']=dt2

v_daily_stats.loc[0,'date']=dt1
#v_daily_stats.loc[len(v_daily_stats)+1,'date']=dt2
####################################################################################################################################################
u_daily_stats['datetimes']=pd.to_datetime(u_daily_stats['date'])
v_daily_stats['datetimes']=pd.to_datetime(v_daily_stats['date'])

u_daily_stats.set_index('datetimes',inplace=True)
v_daily_stats.set_index('datetimes',inplace=True)
