...
cbar1.set_ticks([-0.4,-0.3,-0.2,-0.1,0,0.1,0.2,0.3,0.4])
...
cbar2.set_ticks([-0.4,-0.3,-0.2,-0.1,0,0.1,0.2,0.3,0.4])
...
yy = np.arange(-30,6,10)
yy = np.append(yy,2,axis=None)
...
ax1.set_title(moor + ': '+grid1+ '  vel1',loc='left')
ax2.set_title(grid2 +' vel2',loc='left')
