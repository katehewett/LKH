...
for idx in range(0,12):
    ...
    if idx==0:
        ...
        if var == 'u':
            ...
            plt.text(-0.38, -55, grid1 + ' v1', fontdict={'size': 10, 'color': 'DodgerBlue'})
            plt.text(-0.38, -65, grid2+ ' v2', fontdict={'size': 10, 'color': 'Crimson'})
            plt.text(0.1, -75, 'diff = v2 - v1', fontdict={'size': 10, 'color': 'Green'})
        if var == 'v':
            plt.text(-0.58, -15, moor, fontdict={'size': 10, 'weight': 'bold', 'color': 'black'})
            plt.text(-0.58, -22, str(thisyr), fontdict={'size': 10, 'weight': 'bold', 'color': 'black'})
            plt.text(-0.58, -55, grid1 + ' v1', fontdict={'size': 10, 'color': 'DodgerBlue'})
            plt.text(-0.58, -65, grid2+ ' v2', fontdict={'size': 10, 'color': 'Crimson'})
            plt.text(0.15, -65, 'diff = v2 - v1', fontdict={'size': 10, 'color': 'Green'})
