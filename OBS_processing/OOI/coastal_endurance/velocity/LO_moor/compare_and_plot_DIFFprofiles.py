...
for idx in range(0,12):
    ...
    if idx==0:
        ...
        plt.text(-0.38, -465, grid1 + ' v1', fontdict={'size': 10, 'color': 'DodgerBlue'})
        plt.text(-0.38, -525, grid2+ ' v2', fontdict={'size': 10, 'color': 'Crimson'})

        plt.text(0.1, -525, 'diff = v2 - v1', fontdict={'size': 10, 'color': 'Green'})
