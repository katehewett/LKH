...
LO2_1 = LO2_ds[vel].values[:,28]
LO2_7 = LO2_ds[vel].values[:,-4]
LO2_20 = LO2_ds[vel].values[:,-7]
LO2_80 = np.nanmean(LO2_ds[vel].values[:,(17,18)],axis=1)
LO2_200 = np.nanmean(LO2_ds[vel].values[:,(11,12)],axis=1)
LO2_500 = LO2_ds[vel].values[:,2]
...
if vel == 'u':
    plt.text(datetime(thisyr,6,30), 0.2, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
...
if vel == 'u':
    plt.text(datetime(thisyr,6,30), 0.23, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
    plt.text(datetime(thisyr,6,30), 0.35, grid2, fontdict={'size': 10, 'weight': 'bold', 'color': 'Green'})
if vel == 'v':
    plt.text(datetime(thisyr,6,30), 0.38, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
    plt.text(datetime(thisyr,6,30), 0.2, grid2, fontdict={'size': 10, 'weight': 'bold', 'color': 'Green'})

plt.text(datetime(thisyr,4,1), -0.35, 'OBS(-20m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'DodgerBlue'})
...
ax2.plot(LO2ot,LO2_80,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
...
ax3.plot(LO2ot,LO2_200,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax3.plot(otm,mfd200,color = 'Navy', marker='none', alpha=0.8, linestyle='-', linewidth = 2)

plt.text(datetime(thisyr,5,15), -0.35, 'MFD (-200m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
...
ax4.plot(LO2ot,LO2_500,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax4.plot(otm,mfd500,color = 'Navy', marker='none', alpha=0.8, linestyle='-', linewidth = 2)

if vel == 'u':
    plt.text(datetime(thisyr,5,15), 0.06, 'MFD (-500m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
if vel == 'v':
    plt.text(datetime(thisyr,5,15), 0.3, 'MFD (-500m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
