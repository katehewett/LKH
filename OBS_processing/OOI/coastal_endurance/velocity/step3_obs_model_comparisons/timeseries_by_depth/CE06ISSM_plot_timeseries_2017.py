...
LO2_1 = LO2_ds[vel].values[:,-4]
LO2_7 = LO2_ds[vel].values[:,16]
LO2_15 = LO2_ds[vel].values[:,9]
LO2_25 = LO2_ds[vel].values[:,2]
...
if vel == 'u':
    plt.text(datetime(thisyr,6,30), -0.22, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
...
if vel == 'u':
    plt.text(datetime(thisyr,5,5), -0.18, 'OBS(-7m)', fontdict={'size': 10, 'weight': 'bold', 'color': 'DodgerBlue'})
if vel == 'v':
...
ax3.plot(LO2ot,LO2_15,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
...
ax4.plot(LO2ot,LO2_25,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
...
figname1 = moor+'_'+vel+'_'+str(thisyr)+'_timeseries_both.png'
