...
LO1 = LO_ds[vel].values[:,-3]
LO7 = LO_ds[vel].values[:,-9]
LO20 = LO_ds[vel].values[:,15]
LO50 = np.nanmean(LO_ds[vel].values[:,(6,7)],axis=1)
LO70 = LO_ds[vel].values[:,3]
...
if vel == 'u':
    plt.text(datetime(thisyr,6,30), -0.25, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
    plt.text(datetime(thisyr,6,30), -0.38, grid2, fontdict={'size': 10, 'weight': 'bold', 'color': 'Green'})
    plt.text(datetime(thisyr,5,5), -0.4, 'OBS(-1m)', fontdict={'size': 10, 'weight': 'bold', 'color': 'DodgerBlue'})
if vel == 'v':
    ...
    plt.text(datetime(thisyr,8,15), 0.5, 'OBS(-1m)', fontdict={'size': 10, 'weight': 'bold', 'color': 'DodgerBlue'})
...
if vel == 'u':
    ...
    ax2.set_yticks(np.arange(-0.3,0.4,0.1))
date_format = mdates.DateFormatter('%b%d')
...
if vel == 'u':
    plt.text(datetime(thisyr,5,5), -0.4, 'OBS(-7m)', fontdict={'size': 10, 'weight': 'bold', 'color': 'DodgerBlue'})
if vel == 'v':
    plt.text(datetime(thisyr,8,15), 0.5, 'OBS(-7m)', fontdict={'size': 10, 'weight': 'bold', 'color': 'DodgerBlue'})

#ax2.legend(fontsize=10,loc = 'lower left')
#ax2.set_xticklabels([])

figname1 = moor+'_'+vel+'_'+str(thisyr)+'_timeseries_surface_both.png'
...
nsif50 = nvar[:,np.where(ZN==-50)[0]].squeeze()
...
ZM = dsm.z.values[1,:]
mfd50 = mvar[:,np.where(ZM==-50)[0]].squeeze()
mfd70 = mvar[:,np.where(ZM==-70)[0]].squeeze()

################################################
#plot midlayer -20 -50 -70m
plt.close('all')
fs=12
plt.rc('font', size=fs)
...
if vel == 'u':
    plt.text(datetime(thisyr,8,1), 0.23, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
    plt.text(datetime(thisyr,8,1), 0.35, grid2, fontdict={'size': 10, 'weight': 'bold', 'color': 'Green'})
if vel == 'v':
    plt.text(datetime(thisyr,6,30), 0.38, grid1, fontdict={'size': 10, 'weight': 'bold', 'color': 'Crimson'})
    plt.text(datetime(thisyr,6,30), 0.2, grid2, fontdict={'size': 10, 'weight': 'bold', 'color': 'Green'})

if vel == 'u':
    plt.text(datetime(thisyr,8,1), -0.35, 'NSIF (-20m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'DodgerBlue'})
if vel == 'v':
    plt.text(datetime(thisyr,8,1), 0.35, 'NSIF (-20m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'DodgerBlue'})

ax2 = plt.subplot2grid((5,1), (1,0), colspan=1,rowspan=1)
ax2.axhline(y=0, color='LightGrey', linestyle='-',alpha=0.8)
ax2.plot(LOot,LO50,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax2.plot(LO2ot,LO2_50,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax2.plot(otn,nsif50,color = 'DodgerBlue', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax2.plot(otm,mfd50,color = 'Navy', marker='none', alpha=0.8, linestyle=':', linewidth = 2)

if vel == 'v':
    plt.text(datetime(thisyr,3,5), -0.35, 'NSIF (-50m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'DodgerBlue'})
    plt.text(datetime(thisyr,4,5), -0.35, 'MFD (-50m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
if vel == 'u':
    plt.text(datetime(thisyr,8,1), -0.2, 'NSIF (-50m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'DodgerBlue'})
    plt.text(datetime(thisyr,9,1), -0.2, 'MFD (-50m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})

ax3 = plt.subplot2grid((5,1), (2,0), colspan=1,rowspan=1)
ax3.axhline(y=0, color='LightGrey', linestyle='-',alpha=0.8)
ax3.plot(LOot,LO70,color = 'Crimson', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax3.plot(LO2ot,LO2_70,color = 'Green', marker='none', alpha=0.8, linestyle='-', linewidth = 2)
ax3.plot(otm,mfd70,color = 'Navy', marker='none', alpha=0.8, linestyle='-', linewidth = 2)


if vel == 'u':
    plt.text(datetime(thisyr,5,1), -0.2, 'MFD (-70m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
if vel == 'v':
    plt.text(datetime(thisyr,5,15), 0.3, 'MFD (-70m)', fontdict={'size': 11, 'weight': 'bold', 'color': 'Navy'})
...
if vel == 'u':
    ...
    ax3.set_yticks(np.arange(-0.3,0.4,0.1))
date_format = mdates.DateFormatter('%b%d')
...
figname2 = moor+'_'+vel+'_'+str(thisyr)+'_timeseries_ADCP_both.png'
