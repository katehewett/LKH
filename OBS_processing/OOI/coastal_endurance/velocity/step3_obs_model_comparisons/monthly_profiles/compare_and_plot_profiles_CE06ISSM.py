...
for idx in range(0,12):
    ...
    if idx==0:
        ...
        if var == 'u':
            ...
            plt.text(0.10, -25, grid1, fontdict={'size': 10, 'color': 'DodgerBlue'})
            plt.text(0.10, -28, grid2, fontdict={'size': 10, 'color': 'Crimson'})
            plt.text(0.10, -23, loco, fontdict={'size': 10, 'color': 'Green'})
        if var == 'v':
            plt.text(-0.78, -4, moor, fontdict={'size': 10, 'weight': 'bold', 'color': 'black'})
            plt.text(-0.78, -7, str(thisyr), fontdict={'size': 10, 'weight': 'bold', 'color': 'black'})
            plt.text(-0.78, -25, grid1, fontdict={'size': 10, 'color': 'DodgerBlue'})
            plt.text(-0.78, -28, grid2, fontdict={'size': 10, 'color': 'Crimson'})
            plt.text(-0.78, -23, loco, fontdict={'size': 10, 'color': 'Green'})
    if idx == 8: 
        if var == 'v':
            plt.text(0.2, -28, '+north', fontdict={'size': 10, 'color': 'black'})
        if var == 'u':
            plt.text(0.2, -28, '+east', fontdict={'size': 10, 'color': 'black'})
...
figname = 'monthly_profile_comparision_' + moor+'_'+var+'_'+str(thisyr)+'.png'
