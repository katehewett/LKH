...
ax1 = plt.subplot2grid((2,6), (0,0), colspan=1,rowspan=1)
ax2 = plt.subplot2grid((2,6), (0,1), colspan=1,rowspan=1)
ax3 = plt.subplot2grid((2,6), (0,2), colspan=1,rowspan=1)
ax4 = plt.subplot2grid((2,6), (0,3), colspan=1,rowspan=1)
ax5 = plt.subplot2grid((2,6), (0,4), colspan=1,rowspan=1)
ax6 = plt.subplot2grid((2,6), (0,5), colspan=1,rowspan=1)
ax7 =  plt.subplot2grid((2,6), (1,0), colspan=1,rowspan=1)
ax8 =  plt.subplot2grid((2,6), (1,1), colspan=1,rowspan=1)
ax9 =  plt.subplot2grid((2,6), (1,2), colspan=1,rowspan=1)
ax10 = plt.subplot2grid((2,6), (1,3), colspan=1,rowspan=1)
ax11 = plt.subplot2grid((2,6), (1,4), colspan=1,rowspan=1)
ax12 = plt.subplot2grid((2,6), (1,5), colspan=1,rowspan=1)
...
if moor == 'CE06ISSM':
    ...
    if vel=='V':
        xmin = -0.3
        xmax = 0.3
        xticks = np.arange(xmin, xmax+0.1, 0.15)
        xticks = np.concatenate((xticks,xmax),axis=None)

        xmin2 = -0.3
        xmax2 = 0.3
        xticks2 = np.arange(xmin2, xmax2, 0.15)
        xticks2 = np.concatenate((xticks2,xmax2),axis=None)
